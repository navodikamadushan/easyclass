                    ...
                    RaisedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (user != null) {
                          ...
                          dynamic result = await _database.addNewOnlineClass(_className, _subject, user.uid.toString(), widget.userInfo['name'], context.read<ListProvider>().getAllItems(index));
                          if (result == null) {
