  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        print(snapshot.data.docs.removeWhere((DocumentSnapshot documentSnapshot) => documentSnapshot['teacher_id'] != 'yGrq7oTXNxVM3pkSfyNEEudNjz92').toList()); // snapshot.data.docs[11].id
